...
Node **shape** marks the subject's legally recognized gender in the genogram convention — **squares for men, circles for women**. Line **style** represents the certainty of each connection. Node **color** groups people by sphere.

The sphere categories are organizational shorthands rather than rigid boundaries. Because historical lives naturally overlapped, individuals who could fit into multiple groups are placed in the sphere that best represents their primary historical context on this map.

| Sphere                 | Primary Context                                                                                                                                                                                                                                                                                                                               |
| :--------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Wilde**              | Oscar Wilde himself.                                                                                                                                                                                                                                                                                                                          |
| **Aesthetes**          | Working creatives, writers, artists, and publishers of the Aesthetic movement.                                                                                                                                                                                                                                                                |
| **Society**            | Aristocratic patrons, politicians, and socialites.                                                                                                                                                                                                                                                                                            |
| **1895 trials**        | Figures explicitly brought into the historical record via the trials. Many of the men here would technically fit _outside the circle_, but are grouped here because the trials represent their specific historical intersection with Wilde.                                                                                                   |
| **Chaeronea**          | Shorthand for George Cecil Ives's immediate network and household, including those who may not have been formally initiated into the secret society.                                                                                                                                                                                          |
| **Spouse**             | Legal spouses. This category highlights the structural reality of opposite-sex marriage in this era.                                                                                                                                                                                                                                          |
| **Later circle**       | Figures whose primary intersection with this network occurred later in the early twentieth century, or after Wilde's death.                                                                                                                                                                                                                   |
...
- {{line:married}} **Married**<br>A legal marriage (only permitted between opposite-sex individuals in this time period)
- {{line:self-reported}} **Self-Reported**<br>A participant's own words survive and characterize the connection romantically or sexually: letters, diaries, sworn testimony. The speaker must be one of the two people connected.
...
For completeness, if an individual had both queer and straight connections over the course of their lifetime, both are included for full context. Sources depicting purely platonic warmth and friendship are also documented in the profiles, though they do not generate a connection line on the map.
...
Quotes are fully verified against their source text unless marked with a `⧖ pending verification` warning chip. This chip means the text hasn't been confirmed on the printed page, usually for one of two reasons:

1. A passage was found via text search, but still needs to be cross-referenced against the original document.
2. A promising lead points to a specific source, but the primary text has not yet been consulted and transcribed.

These warning chips reflect the current state of our research. Because this is a living document, the map will shift as more information is uncovered and verified. If you spot an error, have access to a needed primary text, or wish to contribute a new source, you can submit it by [opening an issue on GitHub]({{repo}}/issues).
